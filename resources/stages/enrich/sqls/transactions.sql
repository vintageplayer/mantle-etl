...
FROM crypto_ethereum_raw.blocks AS blocks
    JOIN crypto_ethereum_raw.transactions AS transactions ON blocks.number = transactions.block_number
    JOIN crypto_ethereum_raw.receipts AS receipts ON transactions.hash = receipts.transaction_hash